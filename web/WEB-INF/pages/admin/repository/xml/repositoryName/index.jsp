        ...
        <div class="card-content" style="padding:0;">
            <div class="row" style="margin:0;">
                ...
                <div class="col s12 m4 l4 right-align" style="padding:6px;">
                    <a href="admin/repository/xml/${xmlRepository.name}/automatic_addition.do"
                       class="btn btn-less-padding waves-effect waves-light" title="Automatic add">
                        <i class="material-icons">android</i>
                    </a>
                    <a href="admin/repository/xml/${xmlRepository.name}/manual_addition.do"
                       class="btn btn-less-padding waves-effect waves-light green" title="Manual add">
                        <i class="material-icons">add</i>
                    </a>
                    <a href="admin/repository/xml/deletion.do?id=${xmlRepository.id}" title="Delete repository"
            ...
            <table id="tableFileList" class="striped table-in-a-card" style="table-layout:fixed;">
                ...
                <c:forEach var="xmlFile" items="${xmlFiles}" varStatus="varStatus">
                    <tr>
                        ...
                        <td>
                            <a href="admin/repository/xml/${xmlRepository.name}/xml_editor.do?id=${xmlFile.id}"
                               class="btn btn-less-padding waves-effect waves-light" title="Edit">
                                <i class="material-icons">edit</i>
                            </a>
                            <a href="admin/repository/xml/${xmlRepository.name}/deletion.do?id=${xmlFile.id}"
